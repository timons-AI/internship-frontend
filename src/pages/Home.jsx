...
const Home = () => {
 ...
 <h1 className="text-2xl font-medium text-center text-slate-200  ">Search Results</h1>
  <div className="flex flex-wrap justify-center items-center p-2 bg-gray-100 rounded-md w-3/4 lg:w-10/12 bg-opacity-20 b  ">
...
const Card = ({ company }) => {
  return (
    <div className="flex flex-col p-4 bg-gray-200 rounded-lg w-full  lg:w-1/3 m-2 h-1/5 text-xs">
