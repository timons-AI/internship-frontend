...
const Home = () => {
 ...
 <p className="text-medium text-center text-slate-200 font-extralight ">Click the search </p>
 {isLoading && <p className='text-medium font-extralight text-center text-slate-200'>Loading...</p>}
 { searchResults &&
 <>
  <h1 className="text-medium font-extralight text-center text-slate-200  ">Search Results</h1>
  <div
