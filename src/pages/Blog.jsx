...
<br/><br/><br/>
      ...
      <div className="mt-16">
        ...
        <div className="flex flex-wrap justify-center">
          <a href="/images/Internship-Report-Structure.pdf" download className="inline-block px-6 py-3 bg-blue-500 text-white font-bold rounded-md shadow-md hover:bg-blue-600 mr-4 mb-4">Download Report Structure</a>
          <a href="/images/Internship-Report-Template-1.pdf" download className="inline-block px-6 py-3 bg-green-500 text-white font-bold rounded-md shadow-md hover:bg-green-600 mr-4 mb-4">Download Template 1</a>
          <a href="/images/Internship-Report-Template-2.pdf" download className="inline-block px-6 py-3 bg-purple-500 text-white font-bold rounded-md shadow-md hover:bg-purple-600 mr-4 mb-4">Download Template 2</a>
        </div>
      </div>
