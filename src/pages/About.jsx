  ...
  return (
    <div className="bg-white text-black p-3 ">
      <div className="container mx-auto">
        ...
        <p className="text-lg mb-8">
          With Standard Intern, students can browse internship opportunities, apply directly to companies, and receive personalized recommendations based on their preferences. We also provide resources and support to help students prepare for job interviews and succeed in their internships.
        </p>
        <div className="mt-16">
